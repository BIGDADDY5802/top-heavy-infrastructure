...
<body>
    <div class="container">
        <h1>Melon Crusher</h1>
        <h2>AWS Solutions Architect Associate Games</h2>
       
        <iframe src="https://giphy.com/embed/1h8m1pIizPI1W" width="480" height="271" style="" frameBorder="0" class="giphy-embed" allowFullScreen></iframe><p><a href="https://giphy.com/gifs/cheezburger-exercise-1h8m1pIizPI1W">via GIPHY</a></p>
        <div class="details">
